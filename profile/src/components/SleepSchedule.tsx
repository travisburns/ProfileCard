...
const SleepSchedule = () => {
  ...
  return (
    <div className='bg-purple-900 text-white p-6 min-w-[320px] mx-auto'>
      <h1 className='text-5xl mb-[2.5rem]'>Sleep Schedule</h1>
      <form onSubmit={handleSubmit}>
  <div className='mb-[0.5rem] w-[70%] ml-[.5rem] sm:w-[100%]'>
    <input
      type='text'
      name='date'
      placeholder='Date'
      ...
      className='text-black mr-2 mb-[.5rem] sm:w-[48.5%]'
    />
    <input
      type='text'
      name='time'
    ...
    <input
      ...
      onChange={handleInputChange}
      className='text-black mr-2 mb-[1rem] sm:w-[48.5%]'
    />
    <input
      type='number'
      name='hours'
...
<label className='flex items-center'>
  ...
  <button className='text-[1.5rem] bg-black  ml-[.5rem]' type='submit'>
    Submit Time
      ...
      <h2 className='text-2xl text-slate-500 mt-4 ml-[.5rem]'>Submitted Times</h2>

      <ul className='p-4'>
        {sleepEntries.map((entry, index) => (
          <li key={index} className='border-b border-gray-300 py-2 my-4  bg-blue-500'>
